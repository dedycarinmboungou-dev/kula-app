...
const I18N = {
  fr: {
    ...
    delete_project_short:  'Supprimer ce projet',
    ...
    nav_members:                 'Membres',
    nav_clients:                 'Clients',
    contacts_title_members:      'Membres',
    contacts_title_clients:      'Clients',
    contacts_count_members:      'membres',
    contacts_count_one_member:   'membre',
    contacts_count_clients:      'clients',
    contacts_count_one_client:   'client',
    contact_search_ph:           'Rechercher par nom, téléphone ou email…',
    no_contacts_members:         'Aucun membre pour l’instant',
    no_contacts_clients:         'Aucun client pour l’instant',
    no_contacts_sub:             'Ajoute ton premier contact en cliquant sur le bouton ci-dessous.',
    contact_new:                 'Nouveau contact',
    contact_edit_title:          'Modifier le contact',
    contact_full_name:           'Nom complet *',
    contact_phone:               'Téléphone',
    contact_email:               'Email',
    contact_joined_date:         'Date d’adhésion',
    contact_category:            'Catégorie',
    contact_status:              'Statut',
    contact_status_active:       'Actif',
    contact_status_inactive:     'Inactif',
    contact_notes:               'Notes',
    contact_save:                'Enregistrer',
    contact_cancel:              'Annuler',
    contact_edit:                'Modifier',
    ...
    contact_invalid_email:       'Email invalide',
    contact_name_required:       'Le nom complet est requis',
    ...
    contribution_rule_saved:        'Règle enregistrée',
    freq_mensuelle:                 'Mensuelle',
    freq_trimestrielle:             'Trimestrielle',
    freq_annuelle:                  'Annuelle',
    freq_ponctuelle:                'Ponctuelle',
    contribution_rule_per_mensuelle:    '/ mois',
    contribution_rule_per_trimestrielle:'/ trimestre',
    contribution_rule_per_annuelle:     '/ an',
    contribution_rule_per_ponctuelle:   '· ponctuelle',
    member_contribution_section:    'Cotisations',
    member_no_rule:                 'Aucune règle définie pour cette catégorie',
    member_no_payments:             'Aucun paiement enregistré',
    record_payment:                 'Enregistrer un paiement',
    record_payment_title:           'Enregistrer un paiement',
    payment_amount:                 'Montant (FCFA)',
    payment_amount_required:        'Montant positif requis',
    payment_period:                 'Période',
    payment_period_ph:              'Ex : 2026-04, 2026-Q2, 2026',
    payment_note:                   'Note (optionnel)',
    payment_confirm:                'Confirmer le paiement',
    payment_recorded:               'Paiement enregistré',
    payment_deleted:                'Paiement supprimé',
    confirm_delete_payment:         'Supprimer ce paiement et la transaction associée ?',
    contributions_up_to_date:       'à jour',
    contributions_late:             'en retard',
    contributions_total_collected:  'Total collecté',
    filter_all:                     'Tous',
    filter_ok:                      'À jour',
  ...
  en: {
    ...
    delete_project_short:  'Delete this project',
    ...
    nav_members:                 'Members',
    nav_clients:                 'Clients',
    contacts_title_members:      'Members',
    contacts_title_clients:      'Clients',
    contacts_count_members:      'members',
    contacts_count_one_member:   'member',
    contacts_count_clients:      'clients',
    contacts_count_one_client:   'client',
    contact_search_ph:           'Search by name, phone or email…',
    no_contacts_members:         'No members yet',
    no_contacts_clients:         'No clients yet',
    no_contacts_sub:             'Add your first contact using the button below.',
    contact_new:                 'New contact',
    contact_edit_title:          'Edit contact',
    contact_full_name:           'Full name *',
    contact_phone:               'Phone',
    contact_email:               'Email',
    contact_joined_date:         'Joined date',
    ...
    contribution_rule_saved:        'Rule saved',
    freq_mensuelle:                 'Monthly',
    freq_trimestrielle:             'Quarterly',
    freq_annuelle:                  'Yearly',
    freq_ponctuelle:                'One-off',
    contribution_rule_per_mensuelle:    '/ month',
    contribution_rule_per_trimestrielle:'/ quarter',
    contribution_rule_per_annuelle:     '/ year',
    contribution_rule_per_ponctuelle:   '· one-off',
    member_contribution_section:    'Contributions',
    member_no_rule:                 'No rule defined for this category',
    member_no_payments:             'No payment recorded yet',
    record_payment:                 'Record a payment',
    record_payment_title:           'Record a payment',
    payment_amount:                 'Amount (FCFA)',
    payment_amount_required:        'Positive amount required',
    payment_period:                 'Period',
    payment_period_ph:              'e.g. 2026-04, 2026-Q2, 2026',
    payment_note:                   'Note (optional)',
    payment_confirm:                'Confirm payment',
    payment_recorded:               'Payment recorded',
    payment_deleted:                'Payment deleted',
    confirm_delete_payment:         'Delete this payment and the linked transaction?',
    contributions_up_to_date:       'up to date',
    contributions_late:             'late',
    contributions_total_collected:  'Total collected',
    filter_all:                     'All',
